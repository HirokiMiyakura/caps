		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 mx-auto">
					<h1 class="mb-5 h1 text-center">ご挨拶</h1>
...
お客様の「お悩みの解消」と「未来の安心」の為に全力で取り組んでまいります。</p>
		...
		<div class="container">
			<div class="row justify-content-center text-center">
				<div class="col-md-5" data-aos="fade-up">
					<h1 class="mb-4 h1 text-center">取扱業務</h1>
				</div>
			</div>
			<div class="row">
	...
	<section data-aos="fade-up">
		<div class="container">
			<div class="row justify-content-center text-center">
				<div class="col-md-5">
					<h1 class="mb-5 section-heading h1">新着記事</h1>
				</div>
			</div>
			<div class="col-md-8 mx-auto">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 mx-auto">
					<h1 class="mb-5 h1 text-center">アクセス</h1>
